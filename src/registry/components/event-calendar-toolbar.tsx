...
import { EventCalendarNextIcon, EventCalendarPrevIcon } from '@/registry/components/event-calendar-icons'
  ...
  return (
    <div className={cn('flex items-center justify-between flex-wrap gap-3', className)}>
      <div className='flex items-center shrink-0 gap-3'>
        {addButton && (
          <Button
            // eslint-disable-next-line @typescript-eslint/no-explicit-any -- vendor file (FullCalendar shadcn registry), kept close to upstream
